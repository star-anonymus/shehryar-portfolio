...
export default function Navbar() {
  ...
  return (
    <header className={`fixed top-0 left-0 right-0 z-50 backdrop-blur-md transition-all duration-300 ${scrolled ? "bg-white/95 shadow-sm border-b border-slate-200" : "bg-white/85 border-b border-slate-100"}`}>
